...
def train(opt):
    ...
    if opt.saved_model != '':
        try:
            ...
            print(f'continue to data_train, start_iter: {start_iter}')
        except:
            pass
...
if __name__ == '__main__':
    ...
    parser.add_argument('--num_iter', type=int, default=300000, help='number of iterations to data_train for')
    ...
    parser.add_argument('--character', type=str,
                        default="+@)(*&^%$£[éà`~_{}.,¬#]'/?¬ |:\$01234567-89abcdefghijk;lmnopqrstuvwx=y'z!",
